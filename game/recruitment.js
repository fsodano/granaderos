...
export const CIVIC_RECRUITS=[
 ...
 {...common,id:105,classId:'soldado',foreign:true,tier:'elite',name:'Lucien Arnaud',nickname:'Arnaud',role:'Veterano fusilero francés',biography:'Personaje ficticio. Un veterano expatriado que vende su experiencia de combate por jornadas breves.',monthlyPay:48000,weeklyPay:11200,marksmanship:92,agility:82,leadership:70,weapon:1802,traits:['line_marksman'],sector:'ensenada'},
 {...common,id:106,classId:'gaucho',foreign:false,tier:'elite',ridingSkill:80,name:'Manuel Leiva',nickname:'Leiva',role:'Sargento de frontera',biography:'Personaje ficticio. Un sargento experimentado que se incorpora mediante contratos de campaña.',monthlyPay:41400,weeklyPay:9660,marksmanship:90,strength:83,leadership:75,traits:['teacher'],sector:'buenos_aires'},
 ...MERCENARY_ADDITIONS,
];
