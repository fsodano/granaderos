...
test('physical talk, leadership and regional commitments all gate Brown recruitment',()=>{
 ...
 let next=actBattle(battle,{type:'move',unitId:'3',x:battle.npcs[0].x-2,y:battle.npcs[0].y});next=actBattle(next,{type:'move',unitId:'4',x:battle.npcs[0].x-1,y:battle.npcs[0].y});assert.equal(next.lastError,null);
